...
class Voyager:
    ...
    def learn(self, goals=None, reset_env=True):
        ...
        while True:
            ...
            U.dump_text(f"Iteration: {self.recorder.iteration}, Inventory obtained: {new_inventory}, Total inventory: {self.inventory}, Num: {len(self.inventory)}", f"./results/{self.environment}.txt")
